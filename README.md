...
The following guideline describes the inference module of CELLECT framework. This section aims to demonstrate how to run CELLECT on your own dataset and generate cell tracking results from a folder of 3D image frames.
