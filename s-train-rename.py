...
parser.add_argument('--training_dir', type=str, required=True, help="Training data id")

parser.add_argument('--validation_dir', type=str, required=True, help="Validation data id")
...
training_dir = int(args.training_dir)
validation_dir = int(args.validation_dir)
data_dir = '../extradata/mskcc-confocal'
output_dir = './'
model_dir = './model/'
training_dir = 3
validation_dir = 3
